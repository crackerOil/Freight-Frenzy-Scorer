          ...
          children: [
            ...
            Row(
              children: [
                SizedBox(width: 13),
                Text('Low Goal: '),
                IconButton(icon: Icon(Icons.remove, color: Colors.orange), onPressed: () {
                  setState(() {
                    scores.updateTeleop(lowGoal: scores.teleopDetails.lowGoal -1);
                  });
                }),
            ...
            Row(
              children: [
                ...
                IconButton(icon: Icon(Icons.remove, color: Colors.orange), onPressed: () {
                  setState(() {
                    scores.updateTeleop(midGoal: scores.teleopDetails.midGoal -1);
                  });
                }),
            ...
            Row(
              children: [
                ...
                IconButton(icon: Icon(Icons.remove, color: Colors.orange), onPressed: () {
                  setState(() {
                    scores.updateTeleop(highGoal: scores.teleopDetails.highGoal -1);
                  });
                }),
